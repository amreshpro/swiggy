...
if(email && name && password){
  ...
  return (
    ...
    <>
{
  isAuthenticated ? <Navigate to="/product" replace={true}/> :
    ...
    <div className="mt-4 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <div>
          ...
          <div className="mt-2">
            <input
              ...
              autoComplete="name"
              required
              onChange={(e)=>{setSignupDetail((prev)=>{return {...prev,name:e.target.value}})}}
        ...
        <div>
          ...
          <div className="mt-2">
            <input
              ...
              autoComplete="email"
              required
                  onChange={(e) => { setSignupDetail((prev) => { return { ...prev, email: e.target.value } }) }}
        ...
        <div>
          ...
          <div className="mt-2">
            <input
              ...
              required
              onChange={(e) => { setSignupDetail((prev) => { return { ...prev, password: e.target.value } }) }}
              className="block w-full rounded-md border-0 py-1.5 px-1 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-500 sm:text-sm sm:leading-6"
            />
          </div>
        </div>
      ...
      <p className="mt-4 text-center text-sm text-gray-500">
        Already a member?
        <Link to="/login" className="font-semibold leading-6 text-orange-500 hover:text-orange-700">
         &nbsp; Login
        </Link>
      </p>
    </div>
